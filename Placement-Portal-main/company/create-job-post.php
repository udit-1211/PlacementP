  ...
  <div class="wrapper">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="create-job-post.php"><i class="fa fa-file-o"></i> Post company</a></li>
                    <li><a href="my-job-post.php"><i class="fa fa-file-o"></i> Current Companies</a></li>
                    <!-- <li><a href="job-applications.php"><i class="fa fa-file-o"></i> Drive Compa</a></li>
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2023 <a href="https://www.charusat.ac.in/cdpc.php">CDPC</a>.</strong> All rights
        reserved.
      </div>
    </footer>
